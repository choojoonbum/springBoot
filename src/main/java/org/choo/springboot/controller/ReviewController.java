package org.choo.springboot.controller;

import lombok.RequiredArgsConstructor;
import lombok.extern.log4j.Log4j2;
import org.choo.springboot.dto.ReviewDTO;
import org.choo.springboot.service.ReviewService;
...
public class ReviewController {
    ...
    @PostMapping("/{mno}")
    public ResponseEntity<Long> addReviews(@RequestBody ReviewDTO movieReviewDTO) {
