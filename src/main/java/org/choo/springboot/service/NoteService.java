...
import org.choo.springboot.dto.NoteDTO;
import org.choo.springboot.entity.ClubMember;
import org.choo.springboot.entity.Note;
...
public interface NoteService {
    ...
    default Note dtoToEntity(NoteDTO noteDTO) {
        Note note = Note.builder().num(noteDTO.getNum()).title(noteDTO.getTitle()).content(noteDTO.getContent())
